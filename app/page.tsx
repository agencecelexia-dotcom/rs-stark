    ...
    <div>
      ...
      <section className="hero-section" style={{ position: 'relative', height: '100vh', overflow: 'hidden' }}>
        ...
        >
          ...
          <p className="hero-subtitle" style={{ fontSize: 16, color: 'rgba(255,255,255,0.45)', maxWidth: 400, marginBottom: 40, lineHeight: 1.7 }}>
      ...
      {/* ── CTA REPRISE ── */}
      <section className="hero-cta-section" style={{ padding: '128px 24px', background: '#080808', position: 'relative', overflow: 'hidden' }}>
